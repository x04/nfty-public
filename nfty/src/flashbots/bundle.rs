use crate::flashbots::utils::{deserialize_optional_h160, deserialize_u256, deserialize_u64};
...
impl BundleRequest {
    ...
    pub fn push_transaction<T: Into<BundleTransaction>>(&mut self, tx: T) -> &mut Self {
    ...
    pub fn push_revertible_transaction<T: Into<BundleTransaction>>(&mut self, tx: T) -> &mut Self {
        let tx = tx.into();
    ...
    pub fn set_block(&mut self, block: U64) -> &mut Self {
    ...
    pub fn set_simulation_block(&mut self, block: U64) -> &mut Self {
    ...
    pub fn set_simulation_timestamp(&mut self, timestamp: u64) -> &mut Self {
    ...
    /// in seconds since the UNIX epoch.
    pub fn set_min_timestamp(&mut self, timestamp: u64) -> &mut Self {
    ...
    /// in seconds since the UNIX epoch.
    pub fn set_max_timestamp(&mut self, timestamp: u64) -> &mut Self {
